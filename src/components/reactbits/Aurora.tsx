...
export function Aurora(props: AuroraProps) {
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: GL context is built once; colorStops/blend/speed are read live from propsRef inside the render loop, so they must stay out of the dep array.
	useEffect(() => {
