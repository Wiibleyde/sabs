		...
		<div className="group p-4 md:p-6 bg-white/70 backdrop-blur-xl rounded-xl md:rounded-2xl border border-gray-200/50 shadow-[0_8px_32px_0_rgba(31,38,135,0.1)] transition-all duration-300">
			<div className="flex items-center justify-between mb-4">
				<div className="flex items-center space-x-3">
					<div
						className={`w-10 h-10 bg-gradient-to-br ${isPublish ? "from-sabs-gradient-1 to-sabs-gradient-2" : "from-sabs-gradient-2 to-sabs-gradient-3"} rounded-lg flex items-center justify-center shadow-[0_8px_32px_0_rgba(31,38,135,0.15)]`}
					>
						<svg
