...
export function AuthGuard({ 
    ...
    return (
        <div className={`min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 ${BeVietnam.className} ${className}`}>
            {/* Particules de fond */}
                ...
                <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20 transform transition-all duration-500 hover:scale-105">
                    ...
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-bold text-white mb-2">
                            ...
                            {title.split(' ').slice(1).join(' ') && ` ${title.split(' ').slice(1).join(' ')}`}
                        </h1>
